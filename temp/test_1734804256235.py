...
if __name__ == "__main__":
    # Replace inputs with hardcoded values for testing
    inorder = [1, 2, 3, 4, 5, 6]
    preorder = [4, 2, 1, 3, 5, 6]  # Test case 1
    ...
    print(f"Diameter: {diameter}")  # Expected Diameter: 5

    # Spiral Order Traversal
    spiral_order = level_order_spiral(root)
    print(f"Spiral Order: {spiral_order}")  # Expected: [[4], [2, 5], [1, 3, 6]]
    ...
    print(f"Root to Leaf Paths: {paths}")  # Expected Paths: [[4, 2, 1], [4, 2, 3], [4, 5], [4, 6]]