...
if __name__ == "__main__":
    ...
    inorder = [4, 2, 5, 1, 6, 3]  # Test Input
    preorder = [1, 2, 4, 5, 3, 6]  # Test Input
    ...
    print(f"Lowest Common Ancestor of {p} and {q}: {lca.val if lca else None}")  # Expected Output: 2

    # Root to Leaf Paths
    paths = print_all_paths(root)
    print(f"Root to Leaf Paths: {paths}")  # Expected Output: [[1, 2, 4], [1, 2, 5], [1, 3, 6]]